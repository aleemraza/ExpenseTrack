...
<section className='bg-gray-100 from-blue-50 to-blue-100 dark:from-gray-900 dark:to-gray-800 min-h-screen flex items-center justify-center p-4'>
    <div className="bg-white dark:bg-gray-700 shadow-2xl rounded-3xl w-full max-w-md overflow-hidden grid md:grid-cols-1 transform transition-transform duration-300 hover:scale-105">
        ...
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 400 300" className="mx-auto mb-6 w-48 h-48 animate-pulse">
            ...
            <p className="text-sm text-gray-600 dark:text-gray-300 mb-6">Enter the 6-digit code sent to Email</p>
            ...
            <Link to="/login">
            <button onClick={User_Otp_Verify} className="w-full py-4 bg-blue-500 text-white rounded-xl hover:bg-blue-600
